...
class StudentComments extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            isEditable: false,
    ...
    loadState() {
        axios.get(this.props.endpoint + "/animal/" + this.props.animalId + "/student_comments")
            .then((res) => {
        ...
        return (
            <div className='card'>
                <div className='card-title'>
                    <h1 className="title is-3">Student Comments</h1>
                </div>
                <div className='card-content'>
                    ...
                    {this.state.isEditable && this.props.permission == 1 ?
